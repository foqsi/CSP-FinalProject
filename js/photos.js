...
let lightboxTitle = "CATS";

// Names of the image files shown in the slideshow
let imgFolder = "images/";
let imgFiles = [imgFolder + "cat.jpg", imgFolder + "bigcat.jpg", imgFolder + "twobigcats.jpg", imgFolder + "fastcat.jpg",
imgFolder + "cutekitten.jpg", imgFolder + "stretchycat.jpg", imgFolder + "sillycateatflower.jpg", imgFolder + "peekaboo.jpg",
imgFolder + "sleepykitten.jpg", imgFolder + "sittingcat.jpg", imgFolder + "kittengaze.jpg", imgFolder + "basketofkittens.jpg"]

// Captions associated with each image
let imgCaptions = new Array(12);
imgCaptions[0] = "A picture of a cat";
imgCaptions[1] = "A picture of a big cat";
imgCaptions[2] = "2 big cats!";
imgCaptions[3] = "This one's a fast cat!";
imgCaptions[4] = "Cute kitten";
imgCaptions[5] = "A cat stretching";
imgCaptions[6] = "Silly cat eating a flower";
imgCaptions[7] = "Peekaboo!";
imgCaptions[8] = "Sleepy kitten";
imgCaptions[9] = "A sitting cat";
imgCaptions[10] = "A kitten gazing away";
imgCaptions[11] = "A basket of cuteness!";
